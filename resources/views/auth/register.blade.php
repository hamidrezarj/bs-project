...
@section('content')
    <!-- register -->
    <div class="col d-flex flex-column justify-content-center align-items-center parent-of-cards-signup">
        <div class="register-box p-4 rounded">
            <form class="needs-validation" method="POST" action="{{ route('register') }}" novalidate>
                ...
                <div class="mt-2 d-flex justify-content-center align-items-center">
                    <hr class="col">
                    <a href="{{ route('login') }}"><p id="signIn" class="col up-or-in text-nowrap text-center mx-2 mb-0">ورود به حساب کاربری</p></a>
                    <hr class="col">
                </div>
            </form>
        </div>
