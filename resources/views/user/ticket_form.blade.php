...
<div class="container mt-3">
    ...
    <form action="{{ route('create_ticket') }}" method="POST">
        ...
        <div class="form-floating mb-3">
            <textarea class="form-control @error('description') is-invalid @enderror" name="description" placeholder="Leave a comment here" id="description" style="height: 100px" required>{{ old('description') }}</textarea>
